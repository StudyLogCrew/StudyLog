...
CREATE TABLE timetable (
  ...
  CONSTRAINT sbjctname FOREIGN KEY (subject_name) REFERENCES subject (subject_name) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
INSERT INTO evaluations ( username, eval) VALUES
('JohnDoe', 'Good'),
('JaneSmith', 'Excellent'),
('SamJohnson', 'Average'),
('JohnSmith', 'Good'),
('JaneMason', 'Excellent'),
('OliverJohnson', 'Average'),
('RobertWilliams', 'Good'),
('EmilyAnderson', 'Excellent'),
('MichaelBrown', 'Average'),
('JessicaTaylor', 'Good'),
('DanielDavis', 'Excellent'),
('OliviaMiller', 'Average'),
('DavidWilson', 'Good'),
('SophiaMoore', 'Excellent'),
...
INSERT INTO timetable (username, day, hour, subject_name, cost, number_of_students) VALUES 
('JohnDoe', 'Monday', 9, 'Mathematics', 5.50, 1),
('JohnDoe', 'Wednesday', 11, 'Mathematics', 6.00, 1),
('JohnDoe', 'Friday', 13, 'Mathematics', 4.50, 1),
('EmilyAnderson', 'Tuesday', 14, 'Chemistry', 6.50, 1),
('EmilyAnderson', 'Thursday', 12, 'Chemistry', 5.50, 1),
('EmilyAnderson', 'Friday', 10, 'Chemistry', 4.50, 1),
('OliviaMiller', 'Monday', 15, 'Physics', 5.50, 2),
('OliviaMiller', 'Wednesday', 9, 'Physics', 6.00, 2),
('OliviaMiller', 'Friday', 11, 'Physics', 4.50, 2),
('PedroMartins', 'Tuesday', 13, 'History', 6.50, 3),
('PedroMartins', 'Thursday', 10, 'History', 5.00, 3),
('PedroMartins', 'Friday', 12, 'History', 4.50, 3),
('MarcoSilva', 'Monday', 10, 'History', 5.50, 2),
('MarcoSilva', 'Wednesday', 14, 'History', 6.00, 2),
('MarcoSilva', 'Friday', 9, 'History', 4.50, 2),
('DavidWilson', 'Tuesday', 11, 'Chemistry', 6.50, 1),
('DavidWilson', 'Thursday', 13, 'Chemistry', 5.50, 1),
('DavidWilson', 'Friday', 15, 'Chemistry', 4.50, 1),
('JohnSmith', 'Monday', 14, 'Mathematics', 5.00, 2),
('JohnSmith', 'Wednesday', 10, 'Mathematics', 6.50, 2),
('JohnSmith', 'Friday', 12, 'Mathematics', 5.50, 2),
('RobertWilliams', 'Tuesday', 15, 'English Language and Literature', 5.50, 2),
('RobertWilliams', 'Thursday', 9, 'English Language and Literature', 6.00, 2),
('RobertWilliams', 'Friday', 11, 'English Language and Literature', 4.50, 2),
('JessicaTaylor', 'Monday', 13, 'Biology', 6.50, 1),
('JessicaTaylor', 'Wednesday', 10, 'Biology', 5.00, 1),
('JessicaTaylor', 'Friday', 12, 'Biology', 4.50, 1),
('SophiaMoore', 'Tuesday', 10, 'Physics', 4.50, 2),
('SophiaMoore', 'Thursday', 14, 'Physics', 6.00, 2),
('SophiaMoore', 'Friday', 9, 'Physics', 5.50, 2),
('JamesJohnson', 'Monday', 11, 'Computer Science', 6.50, 3),
('JamesJohnson', 'Wednesday', 9, 'Computer Science', 4.50, 3),
('JamesJohnson', 'Friday', 13, 'Computer Science', 5.00, 3),
('OliverJohnson', 'Tuesday', 12, 'English Language and Literature', 5.50, 1),
('OliverJohnson', 'Thursday', 15, 'English Language and Literature', 6.00, 1),
('OliverJohnson', 'Friday', 12, 'English Language and Literature', 4.50, 1);

INSERT INTO prof_groups (username, group_id, subject_name) VALUES
  ('JohnDoe', 1, 'Mathematics'),
  ('JohnSmith', 2, 'Mathematics'),
  ('EmilyAnderson', 3, 'Chemistry'),
  ('DavidWilson', 4, 'Chemistry'),
  ('OliviaMiller', 5, 'Physics'),
  ('SophiaMoore', 6, 'Physics'),
  ('PedroMartins', 7, 'History'),
  ('MarcoSilva', 8, 'History'),
  ('RobertWilliams', 9, 'English Language and Literature'),
  ('OliverJohnson', 10, 'English Language and Literature'),
  ('JessicaTaylor', 11, 'Biology'),
  ('JamesJohnson', 12, 'Computer Science');

INSERT INTO student_group (username, group_id) VALUES
  ('HenryWilliams', 1),
  ('AbigailTaylor', 2),
  ('AlexanderAnderson', 2),
  ('EllaJohnson', 3),
